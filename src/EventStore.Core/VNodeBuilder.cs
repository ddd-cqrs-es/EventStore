...
namespace EventStore.Core
{
    ...
    public abstract class VNodeBuilder
    {
        ...
        protected IndexVerificationType _indexVerification;
        ...
        protected VNodeBuilder()
        {
            ...
            _index = null;
            _indexVerification = Opts.IndexVerificationDefault;
        ...
        /// <returns>A <see cref="VNodeBuilder"/> with the options set</returns>
        public VNodeBuilder WithIndexVerification(IndexVerificationType indexVerification)
        {
