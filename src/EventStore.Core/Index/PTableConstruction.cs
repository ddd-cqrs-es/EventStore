...
namespace EventStore.Core.Index
{
    ...
    {
        public static PTable FromFile(string filename, int cacheDepth, IndexVerificationType indexVerification)
        {
            return new PTable(filename, Guid.NewGuid(), depth: cacheDepth, indexVerification: indexVerification);
        }
