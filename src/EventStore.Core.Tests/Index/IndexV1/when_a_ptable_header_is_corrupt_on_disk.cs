...
namespace EventStore.Core.Tests.Index.IndexV1
{
    ...
    public class when_a_ptable_header_is_corrupt_on_disk: SpecificationWithDirectory
    {
        ...
        {
            var exc = Assert.Throws<CorruptIndexException>(() => _table = PTable.FromFile(_copiedfilename, 16, IndexVerificationType.MD5));
        ...
        {
            Assert.DoesNotThrow(
                () => _table = PTable.FromFile(_copiedfilename, 16, IndexVerificationType.Disabled)
            );
        }
